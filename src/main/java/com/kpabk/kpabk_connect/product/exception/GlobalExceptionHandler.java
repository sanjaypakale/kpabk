...
@RestControllerAdvice(basePackages = "com.kpabk.kpabk_connect.product.controller")
public class GlobalExceptionHandler {
    ...
    @Schema(name = "ProductErrorBody", description = "Error response from product module")
    @Data
    @Builder
    @NoArgsConstructor
    @AllArgsConstructor
